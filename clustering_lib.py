...
cluster = solutions[2]
division = clusterization(cluster, data)  #output: pos0=cluster1, pos1=cluster2, pos2=cluster3

# what are the variables that have a great contribution to clusterization?
# Now we can calculate F-Measure for each variables.

f_measure_variables = f_variables(data, cluster[0])
print('F-measure for each variable: ', f_measure_variables)
